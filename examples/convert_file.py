...
for game in games:
    for suffix1 in suffixes1:
        for suffix2 in suffixes2:
            PATH = f"/research/erin/zoshao/results/2022_11_28_{game}_{suffix1}_{suffix2}.txt"
            result_path = f"/research/erin/zoshao/results/2022_11_28_{game}_{suffix1}_{suffix2}.results"
            with open(PATH, 'r') as f:
                for l in f:
                    ...
                    d.close()
            f.close()
            print(f"/research/erin/zoshao/results/2022_11_28_{game}_{suffix1}_{suffix2}")
